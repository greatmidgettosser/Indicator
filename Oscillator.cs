...
namespace CompleteOscillator
{
    /// <summary>
    /// Complete Oscillator — a multi-layer momentum & confluence system.
    /// Plots in its own separate pane below price.
    /// </summary>
    public class CompleteOscillator : Indicator
    {
        // ── WAVE SETTINGS ────────────────────────────────────────
        ...
        [InputParameter("Overbought Level", 90, 10, 90, 1, 0)]
        public int OBLevel = 70;

        [InputParameter("Oversold Level", 100, 10, 90, 1, 0)]
        ...
        // ── CONSTRUCTOR ───────────────────────────────────────────
        public CompleteOscillator()
            : base()
        {
            Name = "Complete Oscillator";
