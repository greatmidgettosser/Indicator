...
namespace TradeJournal
{
    ...
    public class TradeJournalPlugin : Plugin
    {
        ...
        // Calendar column width derived from cell width so it always fits exactly 5 columns.
        // Formula: GridStartX(8) + 5 cols * CellW + gap for right arrow(32) 
        private int CalendarColumnWidth => 8 + 5 * _cellW + 32;
        ...
        /// <summary>
        /// (Re)applies the two-column grid layout using the current CalendarColumnWidth.
        /// Called on Initialize and whenever CellW changes via settings.
        /// </summary>
        private void ApplyGridLayout()
        {
            this.Window.ReinitializeGridStructure(new NativeGridDefinition
            {
                ...
                {
                    new NativeGridItemDefinitionDefinition(false, CalendarColumnWidth) { SizeType = NativeGridItemDefinitionSizeType.Pixel },
